      ...
      <div className="container">
        <div className="footer-content">
          <div className="footer-section">
            <h3>About Runes</h3>
            <p>Your AI-powered study assistant for capturing, organizing, and reinforcing knowledge through transcriptions, summaries, and quizzes.</p>
          </div>
          <div className="footer-section">
            ...
            <div className="social-links">
              ...
              <a href="https://discord.com/invite/jSyr2dkP" target="_blank" rel="noopener noreferrer">
                <svg className="social-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="mailto:ewa.edun@gmail.com" className="email-link">
                <svg className="social-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="footer-bottom">
          <p>&copy; 2025 Runes. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
